      ...
      <nav className="h-16 w-full bg-white border-b border-gray-100 px-8 flex items-center justify-between fixed top-0 z-[60]">
        <div className="flex items-center gap-12">
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Search" className="w-64 bg-white border border-gray-300 rounded-full py-2 pl-10 pr-4 text-sm focus:outline-none" />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-6 text-center">
                ...
                <h2 className="text-lg font-bold text-gray-800 leading-tight">{userData.firstName || userData.lastName ? `${userData.firstName} ${userData.lastName}` : "User Name"}</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-8">
                 ...
                 <button className="w-full flex items-center justify-center gap-2 bg-[#125852] text-white py-3 mt-6 rounded-md text-sm font-bold shadow-md">
