...
const OrderManagement = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F9FAFB] font-sans text-slate-700 p-3 gap-3">
      ...
      <aside className="w-56 bg-white border border-slate-200 rounded-2xl flex flex-col sticky top-3 h-[calc(100vh-1.5rem)] shadow-sm">
        ...
        <nav className="flex-1 px-3 py-3 space-y-0.5">
          ...
          <SidebarNavLink to="/order-management" icon={<Truck size={16} />} label="Orders" active />
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Header */}
        <header className="flex items-center justify-between px-5 py-2.5 bg-white border-b border-slate-200 rounded-b-2xl sticky top-0 z-50 h-14 shrink-0 shadow-sm">
          ...
          <div className="flex items-center space-x-3 shrink-0">
            <div className="relative">
              <button className="relative text-slate-500 hover:text-slate-700 transition-colors p-1.5 hover:bg-slate-50 rounded-lg">
                <Bell size={18} />
                <span className="absolute -top-1 -right-1 min-w-[16px] h-3.5 bg-red-500 text-white text-[8px] font-bold rounded-full flex items-center justify-center px-1 ring-2 ring-white">3</span>
              </button>
            </div>
            <div className="flex items-center pl-2.5 border-l border-slate-200">
              <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-[#125852] cursor-pointer shrink-0 bg-slate-100">
