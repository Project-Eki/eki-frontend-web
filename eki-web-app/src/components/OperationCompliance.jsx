...
const OperationCompliance = ({ onFinish, onBack, formData, updateFormData }) => {
  ...
  const handleUpdate = (field, value) => {
    const updatedData = field === 'incorporation_cert' || field === 'national_id' 
      ? { ...formData, documents: { ...formData.documents, [field]: value } }
      : { ...formData, [field]: value };
    
    updateFormData(field === 'incorporation_cert' || field === 'national_id' 
  ...
  const handleSubmit = () => {
    ...
    if (Object.keys(validationErrors).length === 0) onFinish();
  };
