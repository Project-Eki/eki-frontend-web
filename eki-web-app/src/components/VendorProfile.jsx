    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <span
            className={`mt-1.5 inline-block px-2.5 py-0.5 text-[10px] font-bold rounded-full uppercase border ${
              isApproved
      ...
      {isPending && (
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-amber-50 p-3 rounded-xl text-center border border-amber-100">
            <p className="text-[9px] text-amber-600 font-bold uppercase mb-1">
              Days Pending
            </p>
