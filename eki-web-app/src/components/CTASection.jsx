...
const CTASection = () => {
  return (
    <section 
      className="relative text-center py-12 md:py-10 sm:py-8 bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-2xl relative z-10">
        <h2 className="text-4xl md:text-3xl sm:text-2xl font-bold mb-4 text-white">
