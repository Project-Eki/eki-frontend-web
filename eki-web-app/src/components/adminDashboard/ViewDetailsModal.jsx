...
const ViewDetailsModal = ({
  ...
  onEdit,
  onDelete,
  hideActions = false, // ADD THIS — pass hideActions={true} from DataTable for verificationWorkflows
}) => {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "20px",
          boxShadow:
            "0 24px 80px rgba(0,0,0,0.18), 0 1px 0 rgba(255,255,255,0.8) inset",
          overflow: "hidden",
        }}
      >
        {/* Top accent line */}
        <div
          style={{
            height: "3px",
            background: "linear-gradient(90deg, #235E5D, #2d7876, #235E5D)",
        ...
        <div
          ...
          style={{ padding: "8px 28px", maxHeight: "54vh", overflowY: "auto" }}
        >
        ...
        {/* Footer — conditionally show or hide action buttons */}
        <div
          style={{
        ...
        >
          <div className="flex items-center justify-between">
            ...
            {/* CHANGED: only render buttons if hideActions is false */}
            {!hideActions && (
              <div className="flex items-center gap-2.5">
                <button
                  onClick={() => onDelete?.(data)}
