...
// Maps notification_type from the API to a readable label and dot color
  ...
  useEffect(() => {
    const loadNotifications = async () => {
      try {
        ...
        // API returns array — filter unread for the badge count
    ...
    <nav className="flex items-center justify-between px-4 sm:px-8 py-3 bg-white border-b border-gray-100 sticky top-0 z-50 h-16 shrink-0">
      ...
      <div className="flex items-center space-x-6 flex-1 justify-center px-4 sm:px-8">
        <div className="relative hidden sm:block">
          ...
          <input type="text" placeholder="Search" className="pl-10 pr-4 py-2 border border-gray-200 rounded-full bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 w-52 lg:w-64 transition-all text-sm" />
        </div>
