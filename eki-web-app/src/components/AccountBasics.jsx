      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="relative">
            ...
            <input 
              ...
              className={`w-full h-12 pl-11 pr-4 bg-white border ${errors.first_name ? 'border-red-400' : 'border-gray-200'} rounded-2xl focus:border-[#F2B53D] outline-none text-[14px] transition-all`} 
            />
            {errors.first_name && (
          ...
          <div className="relative">
            <input 
              ...
              className={`w-full h-12 px-4 bg-white border ${errors.last_name ? 'border-red-400' : 'border-gray-200'} rounded-2xl focus:border-[#F2B53D] outline-none text-[14px] transition-all`} 
            />
            {errors.last_name && (
              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-[10px] font-bold pointer-events-none">
                {errors.last_name}
        ...
        <div className="relative">
          ...
          <input 
            ...
            className={`w-full h-12 pl-11 pr-4 bg-white border ${errors.email ? 'border-red-400' : 'border-gray-200'} rounded-2xl focus:border-[#F2B53D] outline-none text-[14px] transition-all`} 
          />
          {errors.email && (
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-[10px] font-bold pointer-events-none">
              {errors.email}
        ...
        <div className="relative">
          ...
          <input 
            ...
            className={`w-full h-12 pl-11 pr-12 bg-white border ${errors.password ? 'border-red-400' : 'border-gray-200'} rounded-2xl focus:border-[#F2B53D] outline-none text-[14px] transition-all`} 
          />
        ...
        <div className="flex flex-col gap-1">
          ...
          {/* Error Message shown UNDER the checkbox row */}
          {errors.terms && (
        ...
        {/* Divider and Google buttons below... */}
