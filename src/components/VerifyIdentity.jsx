...
const VerifyIdentity = ({ onNext, onBack, formData }) => { // Added formData prop
  ...
  // NEW: Handle pasting the whole code (UX improvement)
  const handlePaste = (e) => {
  ...
  return (
    <div className="w-full flex flex-col items-center animate-fadeIn">
      ...
      {/* OTP inputs */}
      <div className="flex items-center gap-4 mt-10 mb-10" onPaste={handlePaste}>
      ...
      <div className="w-full max-w-[340px] flex flex-col items-center gap-6">
        <p className="text-gray-500 text-[13px]">
          ...
          <button type="button" className="text-[#F2B53D] font-bold hover:underline cursor-pointer">
            Resend Code
          </button>
        </p>
