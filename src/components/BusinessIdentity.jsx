...
// FIXED: Using proper relative path
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            <input 
              ...
              className={`w-full h-11 pl-4 pr-4 border ${errors.business_name ? 'border-red-400 bg-red-50' : 'border-gray-200'} rounded-xl text-[14px] focus:border-[#F2B53D] outline-none transition-all`} 
            />
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            <select 
              ...
              className={`w-full h-11 pl-4 pr-10 border ${errors.business_type ? 'border-red-400 bg-red-50' : 'border-gray-200'} rounded-xl text-[14px] focus:border-[#F2B53D] outline-none bg-white cursor-pointer appearance-none`}
            >
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            <input 
              ...
              className={`w-full h-11 pl-4 pr-4 border ${errors.owner_full_name ? 'border-red-400 bg-red-50' : 'border-gray-200'} rounded-xl text-[14px] focus:border-[#F2B53D] outline-none transition-all`} 
            />
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            <input 
              ...
              className={`w-full h-11 pl-4 pr-4 border ${errors.registration_number ? 'border-red-400 bg-red-50' : 'border-gray-200'} rounded-xl text-[14px] focus:border-[#F2B53D] outline-none`} 
            />
